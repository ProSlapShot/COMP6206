...
%                                                                                                                       %
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
function canny(max_hysteresis_thresh, min_hysteresis_thresh,sigma);
...
ORIGINAL_IMAGE=imread('Lena.tif');  
 
 
%%Convert to double instead of 8 bit:
...
size_of_kernel= ceil(size_of_kernel/2)
...
subplot(2,2,1), subimage(ORIGINAL_IMAGE)
subplot(2,2,2), subimage(GRADIENT)
subplot(2,2,3), subimage(non_max)
subplot(2,2,4), subimage(post_hysteresis)